...
const projects = [
    {
        id: 1,
        title: 'Movix',
        description: 'A Real time movie app to showcase all latest movies with their ratings. A Real time movie app to showcase all latest movies with their ratings.',
        imageUrl: Project1,
